...
<div class="d-flex justify-content-center py-4">
    <div class="card shadow-sm border-0 rounded-3 w-100" style="max-width: 800px;">
        <div class="card-header bg-guinda text-white fw-semibold fs-5 text-center rounded-top">
            <i class="fas fa-laptop me-2"></i> Nuevo Tipo de Dispositivo
        </div>
            ...
            <form action="{{ route('device_types.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="equipo" class="form-control" id="equipo" value="{{ old('equipo') }}" required placeholder="Ej: Laptop, Monitor">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="descripcion" id="descripcion" class="form-control" rows="3" placeholder="Breve descripción">{{ old('descripcion') }}</textarea>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-end mt-3 gap-2">
                    <button type="submit" class="btn btn-guinda px-4 shadow-sm"><i class="fas fa-save me-1"></i> Guardar</button>
                    <a href="{{ route('device_types.index') }}" class="btn btn-secondary px-4 shadow-sm"><i class="fas fa-times me-1"></i> Cancelar</a>
                </div>
            </form>
        </div>
    </div>
