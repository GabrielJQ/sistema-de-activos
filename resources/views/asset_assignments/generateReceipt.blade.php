...
<html>
<head>
    <title>FORMATO DE ASIGNACION - {{ $employee->full_name }} - {{ $groupedAssignments->keys()->first() }}</title>
    <style>
         /* =========================
...
<div class="container">
    ...
    {{-- PÁGINA 3 : CARTA RESPONSIVA --}}
   <div class="page">
        <table style="width: 100%; border-collapse: collapse; margin: 0; padding: 0;">
            <tr>
                <!-- Columna 1: primer logo -->
                <td style="text-align: left; vertical-align: top; padding: 0;">
                    <img src="{{ public_path('images/logoAgricultura.png') }}" alt="Agricultura Logo" style="height:40px;">
                </td>

                <!-- Columna 2: segundo logo -->
                <td style="text-align: left; vertical-align: top; padding: 0;">
                    <img src="{{ public_path('images/logoAlimentacionBienestar.png') }}" alt="Logo Bienestar" style="height: 40px;">

                </td>

                <!-- Columna 3: espacio vacío -->
                <td style="width: 20%; padding: 0;"></td>

                <!-- Columna 4: logo a la derecha -->
                <td style="text-align: right; vertical-align: top; padding: 0;">
                    <img src="{{ public_path('images/Joven-Mexicana.png') }}" alt="Logo Joven Mexicana" style="height:77px; display:block; margin-top:-30px;" 
                        alt="Logo Joven Mexicana">
                </td>
            </tr>
        </table>
        <br><br>
        <div class="title" style="font-size: 14px; margin-bottom: 5px;">CARTA RESPONSIVA DE RECURSOS INFORMÁTICOS</div>
        <br>
        <div class="carta-date-line">
            OAXACA DE JUÁREZ a {{ strtoupper(\Carbon\Carbon::now()->isoFormat('D [de] MMMM [del] YYYY')) }}
        <br>
    </div>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 20px;">
            Por medio de la presente, declaro que recibo por parte de esta Entidad, el equipo tecnológico, con marca, modelo y números de serie
            indicados en la página uno del <strong>"FORMATO DE ASIGNACIÓN - LIBERACIÓN DE EQUIPAMIENTO TECNOLÓGICO"</strong>, como parte de las actividades
            que involucran mi cargo en esta Entidad, sobre el cual mantendré la custodia hasta el día que la Entidad lo requiera.
        </p>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 20px;">
            Comprendo que durante el periodo en el cual tenga el equipo tecnológico en mención a mi cargo, en el área administrativa en la cual presto
            mis servicios, tengo la obligación de hacer buen uso del mismo, a fin de que el desempeño de mis funciones sea el óptimo para cumplir con
            los objetivos de esta Entidad, conservar el bien señalado en el presente documento y comprendo que no poseo autorización por parte de
            esta Entidad, ni de ningún representante, para utilizar el equipo de cómputo para fines personales, así como para poderlo prestar a ninguna
            persona que así lo requiera.
        </p>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 20px;">
            En caso de robo, daño o siniestro en el equipo tecnológico, me comprometo a denunciar el acontecimiento de forma inmediata ante esta
            Entidad y a las autoridades correspondientes, a fin de que se realicen los procedimientos legales y administrativos pertinentes.
        </p>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 20px;">
            Asumo la responsabilidad sobre el mal uso que haga del equipo de cómputo, así como de realizar las gestiones necesarias para hacer de
            conocimiento a mis superiores de dichas condiciones y en caso de demorar en la denuncia de tales acontecimientos a esta Entidad y a las
            autoridades correspondientes.
        </p>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 30px;">
            En ese sentido asumo que, en caso de que se determine por la autoridad competente una responsabilidad por el mal uso que haga del
            equipo asignado, seré sujeto de cubrir el deducible o cargo correspondiente. De igual manera acepto la responsabilidad del contenido de
            los archivos que se encuentren en el equipo de cómputo asignado a mi nombre y al término de mis actividades y vínculo laboral con la
            Entidad, deberé de hacer entrega del equipamiento al área de sistemas de la Entidad.
        </p>

        <p class="text-justify" style="font-size: 11px; margin-bottom: 50px;">
            Declaro estar de acuerdo con lo anteriormente expuesto, y acepto la responsabilidad que me confiere en este momento al entregarme el
            equipo tecnológico materia de la presente carta responsiva.
        </p>

        <div class="centered-text">
            ATENTAMENTE<br><br><br><br><br><br>
            <div style="border-bottom: 1px solid #000; margin: 0 auto; width: 50%; height: 20px;"></div>
            {{ $employee->full_name }}
        </div>

        {{-- Footer en tabla 1 fila, 2 columnas, pegadas a la izquierda --}}
        <table style="width: 100%; border-collapse: collapse; position: absolute; bottom: 60px; font-size: 9px;">
            <tr>
                <!-- Columna 1: Logo a la izquierda -->
                <td style="text-align: left; vertical-align: top; padding: 0;">
                    <img src="{{ public_path('images/mujerIndigena.png') }}" alt="2025 Año de La mujer Indigena" style="height: 50px;">
                </td>

                <!-- Columna 2: Texto a la derecha, alineado a la izquierda pegado al logo -->
                <td style="text-align: left; vertical-align: top; padding: 0;">
                    <div style="display: inline-block;">
                        <span style="font-weight: bold; line-height: 1.2;">
                            Av. Insurgentes Sur 3483, Col. Villa Olímpica Miguel Hidalgo, Tlalpan. C.P. 14020, Ciudad de México.
                        </span>
                        <div style="border-top: 2px solid #000; margin-top: 2px; width: 100%;"></div>
                    </div>
                </td>
            </tr>
        </table>
